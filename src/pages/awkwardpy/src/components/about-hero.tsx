        ...
        <AnimatePresence>
          ...
          <FadeUp key="description-1" duration={0.6} delay={0.2}>
            <p className="mt-8 text-base font-medium text-zinc-900 dark:text-zinc-300 sm:text-lg md:text-lg">
              Hello, I am Pankaj Rawat, a 22-year-old. I hold a diploma in
              Information Technology. I have foundational knowledge in
              cybersecurity, editing, programming languages, and design.
            </p>
          </FadeUp>
          <FadeUp key="description-2" duration={0.6} delay={0.4}>
            <p className="mt-8 text-base font-medium text-zinc-900 dark:text-zinc-300 sm:text-lg md:text-lg">
              Explore my latest projects showcasing my expertise in Html, Css,
